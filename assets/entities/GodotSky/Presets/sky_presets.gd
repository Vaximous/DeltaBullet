...
@export var sunLightIntensity : Curve = preload("res://assets/entities/GodotSky/Presets/default/sunLightIntensity.tres")
...
@export var moonLightIntensity : Curve = preload("res://assets/entities/GodotSky/Presets/default/moonLightIntensity.tres")
...
@export var baseSkyColor : GradientTexture1D = preload("res://assets/entities/GodotSky/Presets/default/baseSkyColor.tres")
@export var baseCloudColor : GradientTexture1D = preload("res://assets/entities/GodotSky/Presets/default/baseCloudColor.tres")
@export var overcastCloudColor : GradientTexture1D = preload("res://assets/entities/GodotSky/Presets/default/overcastCloudColor.tres")
@export var horizonFogColor : GradientTexture1D = preload("res://assets/entities/GodotSky/Presets/default/horizonFogColor.tres")
@export var sunLightColor : GradientTexture1D = preload("res://assets/entities/GodotSky/Presets/default/sunLight.tres")
@export var sunDiscColor : GradientTexture1D = preload("res://assets/entities/GodotSky/Presets/default/sunDiscColor.tres")
@export var sunGlow : GradientTexture1D = preload("res://assets/entities/GodotSky/Presets/default/sunGlowColor.tres")
@export var moonLightColor : GradientTexture1D = preload("res://assets/entities/GodotSky/Presets/default/moonLight.tres")
@export var moonGlowColor : GradientTexture1D = preload("res://assets/entities/GodotSky/Presets/default/moonGlowColor.tres")
